...
function Bb(a,b,c){var d=u(b),e=d.s;d.s=null;c||(c=(a=a.b[b.slot||"__catchall"])&&a[0]);c?(u(c).assignedNodes.push(b),d.assignedSlot=c):d.assignedSlot=void 0;e!==d.assignedSlot&&d.assignedSlot&&(u(d.assignedSlot).A=!0)}function Db(a,b,c){for(var d=0,e;d<c.length&&(e=c[d]);d++)if("slot"==e.localName){var f=v(e).assignedNodes;f&&f.length&&Db(a,b,f)}else b.push(c[d])}function Eb(a,b){M.dispatchEvent.call(b,new Event("slotchange"));b=v(b);b.assignedSlot&&Eb(a,b.assignedSlot)}
function Ab(a){if(a.c&&a.c.length){for(var b=a.c,c,d=0;d<b.length;d++){var e=b[d];ub(e);ub(e.parentNode);var f=Fb(e);a.b[f]?(c=c||{},c[f]=!0,a.b[f].push(e)):a.b[f]=[e];a.a.push(e)}if(c)for(var g in c)a.b[g]=Gb(a.b[g]);a.c=[]}}function Fb(a){var b=a.name||a.getAttribute("name")||"__catchall";return a.U=b}function Gb(a){return a.sort(function(a,c){a=yb(a);for(var b=yb(c),e=0;e<a.length;e++){c=a[e];var f=b[e];if(c!==f)return a=Array.from(c.parentNode.childNodes),a.indexOf(c)-a.indexOf(f)}})}
function Cb(a){Ab(a);return!(!a.a||!a.a.length)}
if(window.customElements&&w.H){var U=new Map;S=function(){var a=Array.from(U);U.clear();a=r(a);for(var b=a.next();!b.done;b=a.next()){b=r(b.value);var c=b.next().value;b.next().value?c.S():c.T()}};R&&document.addEventListener("readystatechange",function(){R=!1;S()},{once:!0});var Hb=function(a,b,c){var d=0,e="__isConnected"+d++;if(b||c)a.prototype.connectedCallback=a.prototype.S=function(){R?U.set(this,!0):this[e]||(this[e]=!0,b&&b.call(this))},a.prototype.disconnectedCallback=a.prototype.T=function(){R?
this.isConnected||U.set(this,!1):this[e]&&(this[e]=!1,c&&c.call(this))};return a},Ib=window.customElements.define;Object.defineProperty(window.CustomElementRegistry.prototype,"define",{value:function(a,b){var c=b.prototype.connectedCallback,d=b.prototype.disconnectedCallback;Ib.call(window.customElements,a,Hb(b,c,d));b.prototype.connectedCallback=c;b.prototype.disconnectedCallback=d}})};var Jb=L.parentNode;
...
(g=b.querySelectorAll("slot"));f=g&&g.length?g:void 0}f&&(g=e,d=f,g.c=g.c||[],g.a=g.a||[],g.b=g.b||{},g.c.push.apply(g.c,d instanceof Array?d:fa(r(d))))}("slot"===a.localName||f)&&(e=e||z(a))&&T(e);if(x(a)){e=c;rb(a);f=u(a);void 0!==f.firstChild&&(f.childNodes=null);if(b.nodeType===Node.DOCUMENT_FRAGMENT_NODE){f=b.childNodes;for(g=0;g<f.length;g++)tb(f[g],a,e);e=u(b);f=void 0!==e.firstChild?null:void 0;e.firstChild=e.lastChild=f;e.childNodes=f}else tb(b,a,e);e=v(a);if(Mb(a)){T(e.root);var h=!0}else e.root&&
(h=!0)}h||(h=y(a)?a.host:a,c?(c=Nb(c),M.insertBefore.call(h,b,c)):M.appendChild.call(h,b));Ob(a,b);return b}
function Lb(a,b){if(b.parentNode!==a)throw Error("The node to be removed is not a child of this node: "+b);var c=z(b),d=v(a);if(x(a)){var e=u(b),f=u(a);b===f.firstChild&&(f.firstChild=e.nextSibling);b===f.lastChild&&(f.lastChild=e.previousSibling);var g=e.previousSibling,h=e.nextSibling;g&&(u(g).nextSibling=h);h&&(u(h).previousSibling=g);e.parentNode=e.previousSibling=e.nextSibling=void 0;void 0!==f.childNodes&&(f.childNodes=null);if(Mb(a)){T(d.root);var k=!0}}Pb(b);if(c){(e=a&&"slot"===a.localName)&&
(k=!0);if(c.a){Ab(c);f=c.b;for(Y in f)for(g=f[Y],h=0;h<g.length;h++){var l=g[h];if(wa(b,l)){g.splice(h,1);var n=c.a.indexOf(l);0<=n&&c.a.splice(n,1);h--;n=v(l);if(l=n.h)for(var q=0;q<l.length;q++){var D=l[q],P=vb(D);P&&M.removeChild.call(P,D)}n.h=[];n.assignedNodes=[];n=!0}}var Y=n}else Y=void 0;(Y||e)&&T(c)}k||(k=y(a)?a.host:a,(!d.root&&"slot"!==b.localName||k===Jb(b))&&M.removeChild.call(k,b));Ob(a,null,b);return b}
function Pb(a){var b=v(a);if(b&&void 0!==b.j){b=a.childNodes;for(var c=0,d=b.length,e;c<d&&(e=b[c]);c++)Pb(e)}if(a=v(a))a.j=void 0}function Nb(a){var b=a;a&&"slot"===a.localName&&(b=(b=(b=v(a))&&b.h)&&b.length?b[0]:Nb(a.nextSibling));return b}function Mb(a){return(a=(a=v(a))&&a.root)&&Cb(a)}
function Qb(a,b){if("slot"===b)a=a.parentNode,Mb(a)&&T(v(a).root);else if("slot"===a.localName&&"name"===b&&(b=z(a))){if(b.a){var c=a.U,d=Fb(a);if(d!==c){c=b.b[c];var e=c.indexOf(a);0<=e&&c.splice(e,1);c=b.b[d]||(b.b[d]=[]);c.push(a);1<c.length&&(b.b[d]=Gb(c))}}T(b)}}function Ob(a,b,c){if(a=(a=v(a))&&a.i)b&&a.addedNodes.push(b),c&&a.removedNodes.push(c),Rb(a)}
function Sb(a){if(a&&a.nodeType){var b=u(a),c=b.j;void 0===c&&(y(a)?(c=a,b.j=c):(c=(c=a.parentNode)?Sb(c):a,M.contains.call(document.documentElement,a)&&(b.j=c)));return c}}function V(a,b,c){var d=[];Tb(a.childNodes,b,c,d);return d}function Tb(a,b,c,d){for(var e=0,f=a.length,g;e<f&&(g=a[e]);e++){var h;if(h=g.nodeType===Node.ELEMENT_NODE){h=g;var k=b,l=c,n=d,q=k(h);q&&n.push(h);l&&l(q)?h=q:(Tb(h.childNodes,k,l,n),h=void 0)}if(h)break}}var Ub=null;
function Vb(a,b,c){Ub||(Ub=window.ShadyCSS&&window.ShadyCSS.ScopingShim);Ub&&"class"===b?Ub.setElementClass(a,c):(M.setAttribute.call(a,b,c),Qb(a,b))}function Wb(a,b){if(a.ownerDocument!==document||"template"===a.localName)return M.importNode.call(document,a,b);var c=M.importNode.call(document,a,!1);if(b){a=a.childNodes;b=0;for(var d;b<a.length;b++)d=Wb(a[b],!0),c.appendChild(d)}return c};function Xb(){this.c=!1;this.addedNodes=[];this.removedNodes=[];this.w=new Set}function Rb(a){a.c||(a.c=!0,ua(function(){a.flush()}))}Xb.prototype.flush=function(){if(this.c){this.c=!1;var a=this.takeRecords();a.length&&this.w.forEach(function(b){b(a)})}};Xb.prototype.takeRecords=function(){if(this.addedNodes.length||this.removedNodes.length){var a=[{addedNodes:this.addedNodes,removedNodes:this.removedNodes}];this.addedNodes=[];this.removedNodes=[];return a}return[]};
...
"currentTarget");Object.defineProperty(e,"currentTarget",{get:function(){return k},configurable:!0})}if(!y(k)||-1!=e.composedPath().indexOf(k))if(e.composed||-1<e.composedPath().indexOf(k))if(ic(e)&&e.target===e.relatedTarget)e.eventPhase===Event.BUBBLING_PHASE&&e.stopImmediatePropagation();else if(e.eventPhase===Event.CAPTURING_PHASE||e.bubbles||e.target===k||k instanceof Window){var h="function"===d?b.call(k,e):b.handleEvent&&b.handleEvent(e);k!==this&&(f?(Object.defineProperty(e,"currentTarget",
f),f=null):delete e.currentTarget);return h}};b[W].push({node:k,type:a,capture:f,once:g,passive:h,ca:l});hc[a]?(this.__handlers=this.__handlers||{},this.__handlers[a]=this.__handlers[a]||{capture:[],bubble:[]},this.__handlers[a][f?"capture":"bubble"].push(l)):e.call(this,a,l,c)}}}
...
var vc={addEventListener:mc.bind(window),removeEventListener:oc.bind(window)},wc={addEventListener:mc,removeEventListener:oc,appendChild:function(a){return Kb(this,a)},insertBefore:function(a,b){return Kb(this,a,b)},removeChild:function(a){return Lb(this,a)},replaceChild:function(a,b){Kb(this,a,b);Lb(this,b);return a},cloneNode:function(a){if("template"==this.localName)var b=M.cloneNode.call(this,a);else if(b=M.cloneNode.call(this,!1),a&&b.nodeType!==Node.ATTRIBUTE_NODE){a=this.childNodes;for(var c=
0,d;c<a.length;c++)d=a[c].cloneNode(!0),b.appendChild(d)}return b},getRootNode:function(){return Sb(this)},contains:function(a){return wa(this,a)},dispatchEvent:function(a){C();return M.dispatchEvent.call(this,a)}};
...
var xc={get assignedSlot(){return uc(this)}},yc={querySelector:function(a){return V(this,function(b){return na.call(b,a)},function(a){return!!a})[0]||null},querySelectorAll:function(a,b){if(b){b=Array.prototype.slice.call(M.querySelectorAll.call(this,a));var c=this.getRootNode();return b.filter(function(a){return a.getRootNode()==c})}return V(this,function(b){return na.call(b,a)})}},zc={assignedNodes:function(a){if("slot"===this.localName){var b=this.getRootNode();y(b)&&zb(b);return(b=v(this))?(a&&
a.flatten?b.h:b.assignedNodes)||[]:[]}}},Ac=pa({setAttribute:function(a,b){Vb(this,a,b)},removeAttribute:function(a){M.removeAttribute.call(this,a);Qb(this,a)},attachShadow:function(a){if(!this)throw"Must provide a host.";if(!a)throw"Not enough arguments.";return new Q(xb,this,a)},get slot(){return this.getAttribute("slot")},set slot(a){Vb(this,"slot",a)},get assignedSlot(){return uc(this)}},yc,zc);Object.defineProperties(Ac,nb);
var Bc=pa({importNode:function(a,b){return Wb(a,b)},getElementById:function(a){return V(this,function(b){return b.id==a},function(a){return!!a})[0]||null}},yc);Object.defineProperties(Bc,{_activeElement:ob.activeElement});
...
v(this);return b&&b.o[a.f]}}(X),configurable:!0});var Gc={addEventListener:function(a,b,c){"object"!==typeof c&&(c={capture:!!c});c.F=this;this.host.addEventListener(a,b,c)},removeEventListener:function(a,b,c){"object"!==typeof c&&(c={capture:!!c});c.F=this;this.host.removeEventListener(a,b,c)},getElementById:function(a){return V(this,function(b){return b.id==a},function(a){return!!a})[0]||null}};
function Z(a,b){for(var c=Object.getOwnPropertyNames(b),d=0;d<c.length;d++){var e=c[d],f=Object.getOwnPropertyDescriptor(b,e);f.value?a[e]=f.value:Object.defineProperty(a,e,f)}};if(w.H){window.ShadyDOM={inUse:w.H,patch:function(a){rb(a);qb(a);return a},isShadyRoot:y,enqueue:za,flush:C,settings:w,filterMutations:$b,observeChildren:Yb,unobserveChildren:Zb,nativeMethods:M,nativeTree:L,deferConnectionCallbacks:w.deferConnectionCallbacks};tc();var Hc=window.customElements&&window.customElements.nativeHTMLElement||HTMLElement;Z(Q.prototype,Gc);Z(window.Node.prototype,wc);Z(window.Window.prototype,vc);Z(window.Text.prototype,xc);Z(window.DocumentFragment.prototype,yc);Z(window.Element.prototype,
Ac);Z(window.Document.prototype,Bc);window.HTMLSlotElement&&Z(window.HTMLSlotElement.prototype,zc);Z(Hc.prototype,Dc);w.g&&(O(window.Node.prototype),O(window.Text.prototype),O(window.DocumentFragment.prototype),O(window.Element.prototype),O(Hc.prototype),O(window.Document.prototype),window.HTMLSlotElement&&O(window.HTMLSlotElement.prototype));pb();window.ShadowRoot=Q};}).call(this);
